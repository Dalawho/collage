          ...
          <Nav width={0} />
            <div className="flex flex-col gap-4 items-center p-8 mx-auto">
              ...
              <div className="flex border-2 border-slate-800 rounded-lg pl-3 pr-1 w-72">
                ...
                <input className="bg-amber-100 border-none focus:outline-none focus:border-none" type="text" value={price} onChange={(e) => setPrice(parseFloat(e.target.value))} />
              </div>
              <div className="flex border-2 border-slate-800 rounded-lg pl-3 pr-1 w-72">
                <h2 className=" pr-2">Mint:</h2>
                <input className="bg-amber-100 border-none focus:outline-none focus:border-none" type="text" value={mint} onChange={(e) => setMint(parseInt(e.target.value))} />
              </div>
