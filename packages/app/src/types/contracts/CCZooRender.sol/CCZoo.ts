...
export interface CCZooInterface extends utils.Interface {
  functions: {
    ...
    "setPalettes((bytes3[],uint8)[],string[])": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "setPalettes",
    values: [IExquisiteGraphics.PaletteStruct[], PromiseOrValue<string>[]]
  ): string;
  encodeFunctionData(
...
export interface CCZoo extends BaseContract {
  ...
  functions: {
    ...
    setPalettes(
      _newColors: IExquisiteGraphics.PaletteStruct[],
