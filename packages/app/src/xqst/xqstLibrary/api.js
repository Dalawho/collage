import * as ll_api_1 from "./ll_api";
...
export {getBinarySVG_2DArr, getBinarySVG_Array, getRects, getSVG, getSVGPixelBuffer, getSVGPixels, getSVGRects, getSVGRectsPixelBuffer, isRGBA,isString };
